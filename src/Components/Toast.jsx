    ...
    return (
        <>
            {visibility && (
                ...
                >
                    <div
                        className="inline-flex items-center justify-center flex-shrink-0 w-8 h-8 text-green-500 bg-green-200 rounded-lg dark:bg-green-800 dark:text-green-200"
                    >
                        <svg
                            className="w-5 h-5"
                            aria-hidden="true"
                        ...
                        <span className="sr-only">Check icon-ANIL</span>
                    </div>
                    <div className="ms-3 text-sm font-normal">{toastTitle}</div>
                    <button
                        type="button"
